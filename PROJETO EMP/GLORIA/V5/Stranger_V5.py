...
import win32gui
import win32con
from fechar_paginas import fechar_paginas
...
def ciclo_ataque():
    ...
    while True:
        ...
        if not ativar_pagina_especifica():
            print("Falha ao ativar a página. Tentando novamente...")
            time.sleep(2)
            continue
        
        # Tentar fechar janelas indesejadas
        if fechar_paginas('x.png', threshold=0.7, usar_opencv=True):
